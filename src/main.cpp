...
//
    ...
    cout << "parser cmd cost " << get_wall_time() - t0 << " seconds" << endl;
    ...
    cout << "over pre cost " << get_wall_time() - t1 << " seconds" << endl;
    t1 = get_wall_time();
    ...
    cerr << "rabbit_qc v" << RABBITQC_VER << ", total time used: " << t2 - t0 << " seconds" << endl;
